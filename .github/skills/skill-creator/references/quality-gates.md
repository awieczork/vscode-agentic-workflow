Validation rules and banned patterns for skill artifact quality assurance. Every generated skill must pass P1 and P2 gates before delivery. P3 issues are flagged as suggestions. Load this reference during the validation step — scan the skill body against each section.
...
- **Identity prose in skills** (P2) — Fix: "This skill generates...", "This skill is..." — skills instruct, they don't act; use imperative voice
