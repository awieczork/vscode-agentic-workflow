...
4. Project documentation — Is answer in existing docs? (check cookbook/)

## On-Demand
- Own outputs: `workshop/research/` → prior research for patterns (if exists)
...
**Location:** `workshop/research/research-{NNN}-{YYYY-MM-DD}-{topic}.md`
