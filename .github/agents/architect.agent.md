...
## On-Demand
- Own outputs: `workshop/plans/` → prior plans for patterns (if exists)
- Project documentation as referenced in projectbrief
- Build reports: `workshop/builds/` when verifying completed work (if exists)
...
**Location:** `workshop/plans/architect-{NNN}-{YYYY-MM-DD}-{topic}.md`
