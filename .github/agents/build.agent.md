...
4. Load the **plan** from `workshop/plans/` (if provided)

## On-Demand
- Own outputs: `workshop/builds/` → prior builds for patterns (if exists)
...
**Location:** `workshop/builds/build-{NNN}-{YYYY-MM-DD}-{topic}.md`
