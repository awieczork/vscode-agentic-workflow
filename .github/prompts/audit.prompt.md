...
Orchestrate a full read-only audit of this repository. Spawn parallel researcher instances — one per audit dimension below — then synthesize findings into a unified audit report. Do not apply fixes; report findings and recommendations only.
